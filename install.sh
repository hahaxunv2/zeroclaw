...
BOOTSTRAP_URL="${ZEROCLAW_BOOTSTRAP_URL:-https://raw.githubusercontent.com/zeroclaw-labs/zeroclaw/main/install.sh}"
...
Examples:
  ...
  ./install.sh --docker --docker-config ./config.toml --docker-daemon
