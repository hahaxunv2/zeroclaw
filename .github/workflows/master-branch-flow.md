...
Current maintainers: `theonlyhennygod`, `jordanthejet`, `chumyin`, and `SimianAstronaut7`.
...
2. `ci.yml` starts:
   - `test` job: runs `cargo nextest run --locked` on `ubuntu-latest` with Rust 1.82.0 and mold linker.
